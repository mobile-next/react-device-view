...
var NinePatchSkinView = ({ skin, screenSize, children }) => {
  ...
  return (
    ...
    /* @__PURE__ */ jsx("div", { style: { height: "100%", aspectRatio: `${frame.width} / ${frame.height}`, maxWidth: "100%", containerType: "size", display: "grid", placeItems: "center" }, children: /* @__PURE__ */ jsxs(
      "div",
      {
        style: {
        ...
        children: [
          ...
          skin.buttons.map((b, i) => /* @__PURE__ */ jsx(
            "div",
            {
              style: {
                position: "absolute",
...
var DeviceSkinComponent = ({ deviceSkin, screenSize, children }) => {
  if (deviceSkin.ninePatch) {
    return /* @__PURE__ */ jsx(NinePatchSkinView, { skin: deviceSkin.ninePatch, screenSize, children });
  }
...
export { AvcStream, ConnectionError, DeviceClient, DeviceControls, DeviceInstance, DevicePlatform, DeviceState, DeviceType, DeviceView, DeviceViewport, JsonRpcClient, MjpegStream, NinePatchSkinView, NoDeviceSkin, WebRtcStream, androidNinePatchSkin, createNoOpDeviceClient, getDeviceSkinForDevice, iosNinePatchSkin, mapButtonTop, nativeFrameSize, nativeScreenSlot };
