...
import { DeviceClient, DeviceClientApi } from './rpc/DeviceClient';
...
export const DeviceView = forwardRef<DeviceViewHandle, DeviceViewProps>(
  (
    { serverUrl, token, deviceId, platform, showControls = true, onError, onConnected, onFirstFrame, onDisconnected, onInstallApp, onOpenUrl },
    ref,
  ) => {
